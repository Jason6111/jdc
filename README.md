...
```
wget -O Config.json  https://raw.githubusercontent.com/Jason6111/jdc/main/Config.json
```
国内请使用
 ```
wget -O Config.json  https://ghproxy.com/https://raw.githubusercontent.com/Jason6111/jdc/main/Config.json
```
